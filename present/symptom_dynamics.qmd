...
So this term actually adds nonlinearity into our model as this is the interaction term between $S_i$ and $S_j$ and also as we use the quadratic function for f, it enables our model to capture the nonliear responses.
...
I made one exception for the symptom suicidal, and made the beta to be smaller so it becomes more challenging to get activated.
About this, I will show you in more detail in the following slide.
:::
...
So we did find some clear distinctive network structures in different level of resilience.
That is one of the points I'd like to highlight.
:::
...
And also, the guilty symptom sort of acts as a bridge between these two clusters, which can be also seen in the original network structure.
...
And of course, this is just a very start.
...
And I was really hoping that I could hear what you guys think about this.
And if you have any idea on what you can do with this type of model or any idea on some interesting extension for this work, I would love to hear it.
:::
