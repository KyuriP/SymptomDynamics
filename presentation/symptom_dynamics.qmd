...
::: r-stack
![](img/commoncause1.png){.absolute top="200" left="200" width="60%"}
![](img/commoncause2.png){.fragment .absolute top="200" left="200" width="60%"}
:::
...
::: notes
So the results.
Quickly about the set up, so for each iteration, we simulated over 4000 timepoints, and the shock was given at where t = 1000 and the shock lasted for 500 time points.
