...
## save datasets
# saveRDS(aggregated, "aggregated_base.rds") # delta = 9, # -omega * (1 + 0.41)
# saveRDS(aggregated, "aggregated_base2.rds") # delta = 9, # -omega * (1 + 0.405)
# saveRDS(aggregated, "aggregated_high.rds") # delta = 8, # -omega * (1 + 0.405)
saveRDS(aggregated, "aggregated_low.rds") # delta = 10, # -omega * (1 + 0.405)

# saveRDS(aggregated, "aggregated_base2.rds") # delta = 9, # -omega * (1 + 0.41)
# saveRDS(aggregated, "aggregated_base2.rds") # delta = 8, # -omega * (1 + 0.41)
# saveRDS(aggregated, "aggregated_base2.rds") # delta = 10, # -omega * (1 + 0.41)
